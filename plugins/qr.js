...
if (Config.WORKTYPE == 'private') {
    ...
    Spike.addCommand({pattern: 'qr ?(.*)', fromMe: true, desc: Lang.QR_DESC}, (async (message, match) => {
        ...
        await message.sendImage(Buffer.from(webimage.data), '*Made By Spike*');

    }));

    Spike.addCommand({pattern: 'readqr ?(.*)', fromMe: true, desc: Lang.QR_DESC}, (async (message, match) => {
    ...
    Spike.addCommand({pattern: 'qr ?(.*)', fromMe: false, desc: Lang.QR_DESC}, (async (message, match) => {
    ...
    Spike.addCommand({pattern: 'readqr ?(.*)', fromMe: false, desc: Lang.QR_DESC}, (async (message, match) => {
