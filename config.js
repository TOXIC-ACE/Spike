...
DATABASE_URL = process.env.DATABASE_URL === undefined ? './spike.db' : process.env.DATABASE_URL;
...
module.exports = {
    ...
    OWNER: process.env.OWNER_NAME === undefined ? 'TOXIC ACE' : process.env.OWNER_NAME,
    OWNERNUM: process.env.OWNER_NUMBER === undefined ? '919846720547' : process.env.OWNER_NUMBER,
    ...
    DATABASE: DATABASE_URL === './spike.db' ? new Sequelize({ dialect: "sqlite", storage: DATABASE_URL, logging: DEBUG }) : new Sequelize(DATABASE_URL, { dialectOptions: { ssl: { require: true, rejectUnauthorized: false } }, logging: DEBUG }),
